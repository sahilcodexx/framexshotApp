...
const ONBOARDING_STEPS = [
  ...
  },
  {
    id: "capture-modes",
    title: "Capture Modes",
    description: "FrameXShot offers three ways to capture your screen, each with a handy keyboard shortcut.",
    icon: (
      <svg className="size-8 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path
          strokeLinecap="round"
    ...
    content: (
      <div className="space-y-4">
        ...
        <div className="p-4 bg-secondary rounded-lg border border-border">
          ...
          <p className="text-xs text-muted-foreground text-pretty">
            Choose the image FrameXShot uses for auto-apply and as the starting point in the editor.
          </p>
        </div>
        <div className="p-4 bg-secondary rounded-lg border border-border">
  ...
  },
  {
    ...
    description:
      "FrameXShot needs Screen Recording permission from macOS before it can capture your screen.",
    icon: (
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1 space-y-1">
              ...
              <ul className="text-xs text-amber-300/80 space-y-1 text-pretty list-disc list-inside">
                ...
                <li>FrameXShot cannot capture anything until this is granted.</li>
              </ul>
            </div>
          </div>
        </div>
        <div className="space-y-3">
          <div className="p-4 bg-secondary rounded-lg border border-border">
            ...
            <ol className="text-xs text-muted-foreground space-y-1 list-decimal list-inside text-pretty">
              ...
              <li>Toggle on <span className="text-foreground font-mono">framexshot</span> in the list.</li>
              <li>Restart FrameXShot so the change takes effect.</li>
            </ol>
          </div>
          <div className="p-4 bg-secondary rounded-lg border border-border">
            ...
            <p className="text-xs text-muted-foreground text-pretty">
              ...
              <span className="text-foreground font-mono">
                "framexshot" would like to record this computer&apos;s screen and audio.
              </span>{" "}
